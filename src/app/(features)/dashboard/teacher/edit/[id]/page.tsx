...
export default function TeacherEditPage() {
  ...
  // Charger les infos de l’enseignant existant
  const fetchTeacher = async () => {
    try {
      ...
      setFormData({
        ...
        grade: teacher.grade || "",
        is_permanent: teacher.is_permanent ?? true,
        metadata: {
          experience: teacher.metadata?.experience || "",
          linkedin: teacher.metadata?.linkedin || "",
        },
      });
    } catch (error) {
    } finally {
              ...
              <div className="p-8 border-b border-gray-200">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  <div className="flex items-center">
                    ...
                    />
                    <label htmlFor="is_permanent" className="ml-3 text-sm text-gray-700">
