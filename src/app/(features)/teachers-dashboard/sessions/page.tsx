// teachers-dashboard/sessions/page.tsx
'use client';
...
export default function SessionsPage() {
  ...
  const handleCreateSession = () => {
    router.push("/teachers-dashboard/sessions/create");
  };

  // Fonction pour se déconnecter en cas d'erreur d'authentification
  const handleLogout = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gray-50">
        <TeacherPageHeader
          title="Sessions"
          subtitle="Gérez vos sessions de quiz et examens"
          actionButton={{
